...
export const DEFAULT_RULES: string[] = [
    ...
    'Памятка по маслам и сметане: Сливочное масло (от 82.5%), растительные масла и жирная сметана — это тяжелая артиллерия жиров. Их категорически запрещено добавлять к углеводам (гречка, рис, макароны, картофель). Они идут СТРОГО в жировой прием пищи (вечером) или в дни отдыха.',
];
