...
export const DEFAULT_RULES: string[] = [
    ...
    'Сливочное/кокосовое масло и сметана — тяжелая артиллерия жиров. СТРОГО в жировой прием (вечером или в дни отдыха). Категорически запрещено добавлять к кашам/макаронам.',
];
